                            ...
                            <ul>
                                <c:forEach items="${ListT}" var ="o">
                                    <li>
                                        ...
                                        <c:set var = "Follow" scope = "session" value = "Follow"/>

                                        <c:forEach items="${followBrands}" var ="b">
                                            <c:if test="${o.type == b.getBrandName()}">
                                                <c:set var = "Follow" scope = "session" value = "Unfollow"/>
                                            </c:if>
                                        </c:forEach>
                                        <button id="button-id-${o.type}" onclick="changeFollow(this)"><c:out value="${Follow}"/> </button>
                                    </li>
                                </c:forEach>
                            </ul>
                        </div>
