        ...
        <div class="payment-row">
            <div class="row-left">
                <div class="p-4" style="width: 90%; text-align: center;">
                    ...
                    <form action="paymentController" class="flex flex-col gap-5 sm:gap-10 mt-4 py-2" method="post">
                        <div>
                        ...
                        <div>
                            <div class="relative w-full">
                                <input label="Địa chỉ "
                                       class="py-3 px-4 border-b w-full focus:bg-none placeholder-transparent focus:outline-none peer relative"
                                       name="address" /><label
                                    class="absolute capitalize left-2 -top-2.5 text-sm text-gray-400 transition-all bg-transparent peer-placeholder-shown:top-2.5 peer-focus:-top-2.5 peer-focus:text-sm">Địa Chỉ</label>
                            </div>
                        </div>
                        <div class="method-delivery">
                            <p style="font-weight: bold;">Method of payment</p>
                            <div class="content-row-left">
                                <input name="typePayment" type="radio" value="paypal">
                                <label>Pay with Paypal</label>
                            </div>
                            <div class="content-row-left">
                                <input name="typePayment" type="radio" value="cash">
...
<%--            var radioBtn = document.getElementsByName("typePayment");--%>
